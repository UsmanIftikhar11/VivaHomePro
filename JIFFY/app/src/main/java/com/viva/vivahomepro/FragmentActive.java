...
//    private final String URL_PRODUCTS = "http://192.168.10.8/vivahomepro/leads2.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvServiceRequest = v.findViewById(R.id.rvServiceRequest);
        /*cv1 = v.findViewById(R.id.cv1);
        cv2 = v.findViewById(R.id.cv2);*/
        rvServiceRequest.setHasFixedSize(true);
        rvServiceRequest.setLayoutManager(new LinearLayoutManager(getActivity()));

        //initializing the productlist
        serviceList = new ArrayList<>();

/*
        cv1.setOnClickListener(v1 -> {
    ...
    private void loadProducts() {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            ServiceAdapter adapter = new ServiceAdapter(getActivity(), serviceList);
...

        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("tstatus", "In Progress");
